...
export class AddPublicIdsAndOrgSettings1704067209000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      ADD COLUMN public_id UUID DEFAULT uuid_generate_v4() UNIQUE NOT NULL
    `);
    ...
    await queryRunner.query(`CREATE INDEX idx_users_public_id ON admin.users(public_id)`);
    await queryRunner.query(`CREATE INDEX idx_employees_public_id ON core.employees(public_id)`);
    await queryRunner.query(`CREATE INDEX idx_departments_public_id ON core.departments(public_id)`);
    await queryRunner.query(`CREATE INDEX idx_payslips_public_id ON payroll.payslips(public_id)`);
    ...
    await queryRunner.query(`
      CREATE TABLE admin.organization_settings (
        ...
        organization_id BIGINT REFERENCES admin.organizations(id) ON DELETE CASCADE,
    ...
    await queryRunner.query(`
      CREATE TABLE admin.id_sequences (
        id BIGSERIAL PRIMARY KEY,
        organization_id BIGINT NOT NULL REFERENCES admin.organizations(id) ON DELETE CASCADE,
    ...
    await queryRunner.query(`
      CREATE INDEX idx_id_sequences_lookup
    ...
    await queryRunner.query(`
      ...
      SELECT id FROM admin.organizations
